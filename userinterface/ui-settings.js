...
(function () {
  ...
  window.OdinModules.push(function OdinUIModule_SettingsInit(OdinContext) {
    ...
    function renderSettings() {
      ...
      const apiCard = UI.createCard(null, `
      ...
      const displayCard = UI.createCard(null, `
      ...
      const notifCard = UI.createCard(null, `
        <div style="display: flex; flex-direction: column; gap: 12px;">
          <div style="display: flex; align-items: center; gap: 8px;">
      ...
      const frekiCard = UI.createCard(null, `
        <div style="display: flex; flex-direction: column; gap: 12px;">
          <div style="display: flex; align-items: center; gap: 8px;">
      ...
      const actionsCard = UI.createCard(null, `
      ...
      const versionCard = UI.createCard(null, `
