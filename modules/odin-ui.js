...
(function () {
  ...
  function destroy() {
    ...
    // Profile injection (profile pages)
    try {
      if (!__profileInjection) __profileInjection = createProfileInjectionModule();
      if (__profileInjection && typeof __profileInjection.init === 'function') __profileInjection.init(ctx);
    } catch (e) {
      try { console.warn('[ODIN_UI] Profile injection init failed:', e); } catch {}
    }
});
})();
