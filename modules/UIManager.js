...
.odin-content.odin-content.odin-content-auth {
  display: flex;
  flex-direction: column;
  height: 500px;
...
.odin-auth-scroll::-webkit-scrollbar,
.odin-auth-scrollbox::-webkit-scrollbar { width: 6px; }
.odin-auth-scroll::-webkit-scrollbar-track,
.odin-auth-scrollbox::-webkit-scrollbar-track { background: rgba(5, 5, 10, 0.85); }
.odin-auth-scroll::-webkit-scrollbar-thumb,
.odin-auth-scrollbox::-webkit-scrollbar-thumb { background: rgba(233, 69, 96, 0.85); border-radius: 3px; }
