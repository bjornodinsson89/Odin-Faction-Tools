...
function renderAuthGate() {
    const content = document.querySelector(".odin-content");
    content.classList.add("odin-content-auth");
    content.innerHTML = `
        <div class="odin-auth-header">
            <h3>Authentication Required</h3>
        </div>
        <div class="odin-auth-disclaimer">
            ${DISCLAIMER_HTML}
        </div>
        <div class="odin-auth-controls">
            <label><input type="checkbox" id="odin-auth-ack"> I understand and agree</label>
            <input type="password" id="odin-api-key" placeholder="Enter Torn API Key">
            <button id="odin-auth-btn">Authenticate</button>
        </div>
    `;
}

.odin-auth-header { flex: 0 0 auto; }
.odin-auth-disclaimer {
    flex: 1 1 auto;
    overflow-y: auto;
    padding: 10px;
...
function createToggleButton() {
    ...
    img.src = "https://i.postimg.cc/BQ6bSYKM/file-000000004bb071f5a96fc52564bf26ad-(1).png";
    img.style.width = "100%";
