// ui-settings.js
// Settings panel UI
// Version: 3.2.0 - Added FFScouter key support
      ...
      const apiCard = UI.createCard(`
        <div style="display: flex; flex-direction: column; gap: 16px;">
          ...
          <div>
            ...
            <input type="password" id="setting-ffscouter-api-key" 
              value="${settings.ffScouterApiKey || ''}"
              placeholder="Leave blank to use Torn API key"
              style="
                width: 100%;
                padding: 10px 12px;
                background: rgba(0,0,0,0.3);
              ...
              ">
            <p style="font-size: 11px; color: #718096; margin-top: 4px;">
              Optional. If empty, Odin will use your Torn API key when calling FFScouter.
            </p>
          </div>
    ...
    function attachEventListeners() {
      ...
      document.getElementById('setting-save')?.addEventListener('click', () => {
        ...
        if (window.OdinApiConfig) {
          ...
          if (window.OdinApiConfig.setFFScouterApiKey) {
            window.OdinApiConfig.setFFScouterApiKey(newSettings.ffScouterApiKey || '');
          }
        }
