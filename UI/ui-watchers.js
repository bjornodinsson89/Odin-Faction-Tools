          ...
          <div style="display: flex; align-items: center; gap: 16px;">
            ...
            <div style="flex: 1;">
              ...
              <div style="font-size: 12px; color: #718096; margin-top: 4px;">
                Start: ${new Date(currentShift.startTime).toLocaleString()}<br>End: ${new Date(currentShift.endTime).toLocaleString()}
              </div>
            </div>
            ...
            ">
              <div>
                ...
                <div style="font-size: 12px; color: #718096; margin-top: 2px;">
                  Start: ${startTime.toLocaleString()}<br>End: ${endTime.toLocaleString()}
                </div>
