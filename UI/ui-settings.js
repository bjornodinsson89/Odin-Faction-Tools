    ...
    function renderSettings() {
      ...
      const versionCard = UI.createCard(`
        <div style="text-align: center; padding: 16px;">
          <div style="font-size: 24px; margin-bottom: 8px;"><img class="odin-logo" alt="Odin" src="https://i.postimg.cc/YkN9wp48/Bear-head.png" style="width:24px;height:24px;vertical-align:-5px;margin-right:8px;object-fit:contain;filter:drop-shadow(0 2px 6px rgba(0,0,0,0.45));"/>Odin Tools</div>
